...
namespace UploadApi.Exceptions
{
    public class GlobalExceptionsHandler
    {
        ...
        private int GetStatuscode(Exception exceptions)
        {
            ...
            else if (exceptions is BookMetaDataSaveFailedException) return StatusCodes.Status400BadRequest;
        ...
        private string GetErrorMessage(Exception exceptions)
        {
            ...
            else if (exceptions is BookMetaDataSaveFailedException) return "Book already exists";

            else if (exceptions is FailedSaveBookException) return "Failed to save book";
